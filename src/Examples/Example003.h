...
// - загрузка текстуры через TextureManager
...
public:
	Example003() = default;
	Example003(const Example003&) = delete;
	Example003(Example003&&) = delete;
	void operator=(const Example003&) = delete;
	void operator=(Example003&&) = delete;

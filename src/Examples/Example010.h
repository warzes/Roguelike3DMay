...
class Example010 final : public IEngineApp
{
public:
	Example010() = default;
	Example010(const Example010&) = delete;
	Example010(Example010&&) = delete;
	void operator=(const Example010&) = delete;
	void operator=(Example010&&) = delete;

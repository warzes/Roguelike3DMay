...
{
	/*
	TODO: для карты теней нужно попробовать рендерить низкоуровневые лоды (детальность не нужна?) при этом одним буфером (indirect)
	также сделать настройку sceneDraw - не нужно биндить текстуры во время рендера буфера глубины
	*/

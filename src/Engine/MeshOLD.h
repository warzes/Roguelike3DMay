...
private:
	...
	// Render data 
	gl::VertexArrayId m_vao{0}; // TODO: возможно vao должно быть одно для всех моделей, а буферы размещать за счет glVertexArrayVertexBuffer/glVertexArrayElementBuffer
	gl::BufferId m_vbo{0};
	gl::BufferId m_ibo{0};
};